<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:52:"D:\tp\public/../application/admin\view\cate\edit.htm";i:1523264890;s:43:"D:\tp\application\admin\view\common\top.htm";i:1522027061;s:44:"D:\tp\application\admin\view\common\left.htm";i:1523169237;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>添加品牌</title>
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="pid">
                                                    ...
                                                    <option <?php if($cates['id'] == $cate['id']): ?> disabled="disabled" <?php endif; if(($cates['cate_type'] == 1 ) or ($cates['cate_type'] == 2 ) or ($cates['cate_type'] == 3 ) or ($cates['cate_type'] == 4 )): ?> disabled="disabled" <?php endif; if($cate['cate_type'] != 5): ?> disabled="disabled" <?php endif; if($cate['id'] == $cates['pid']): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo str_repeat('-',$cate['level']*8) ?><?php echo $cate['cate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio"  style="float: left;padding-right: 10px">
                                                <label>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <input class="colored-blue" name="show_nav" value="1" type="radio" <?php if($cates['show_nav'] == 1): ?> checked="checked" <?php endif; ?>>
                                                    <span class="text"> 是 </span>
                                                </label>
                                            </div>
                                            <div class="radio"  style="float: left">
                                                <label>
                                                    <input class=" colored-blue" name="show_nav" value="0" type="radio"   <?php if($cates['show_nav'] == 0): ?> checked="checked" <?php endif; ?>">
