<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:52:"D:\tp\public/../application/admin\view\brand\lst.htm";i:1523261901;s:43:"D:\tp\application\admin\view\common\top.htm";i:1522027061;s:44:"D:\tp\application\admin\view\common\left.htm";i:1523169237;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <?php if(is_array($brandRes) || $brandRes instanceof \think\Collection || $brandRes instanceof \think\Paginator): $i = 0; $__LIST__ = $brandRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td align="center"><?php echo $brand['brand_name']; ?></td>
                                 <td ><a herf="<?php echo $brand['brand_url']; ?>" target="_blank"><?php echo $brand['brand_url']; ?></a></td>
                                <td align="center">
                                    <?php if($brand['brand_img'] != ''): ?>
                                        <img src="/public/static/uploads/<?php echo $brand['brand_img']; ?>" height="30">
                                    <?php else: ?>
                                        暂无图片

                                    <?php endif; ?>
                                </td>
                                <td align="left"><?php echo cut_str($brand['brand_description'] ,6); ?></td>
                                <td align="center">
