<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:52:"D:\tp\public/../application/admin\view\brand\add.htm";i:1522049161;s:43:"D:\tp\application\admin\view\common\top.htm";i:1522027061;s:44:"D:\tp\application\admin\view\common\left.htm";i:1523169237;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>添加品牌</title>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('Brand/index'); ?>">品牌管理</a>
                       </li>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio"  style="float: left;padding-right: 10px">
                                <label>
                                    &nbsp;&nbsp;&nbsp;
                                    <input class="colored-blue" name="status" value="1" type="radio"  checked="checked">
                                    <span class="text"> 显示 </span>
                                </label>
                            </div>
                            <div class="radio"  style="float: left">
                                <label>
                                    <input class=" colored-blue" name="status" value="0" type="radio"">
